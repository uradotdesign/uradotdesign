 ...
 */
const VIEWS = {
  case_studies: { columns: ["status", "client_name", "translations", "sort_order"], sort: ["sort_order"], sortField: "sort_order", archive: true },
  case_study_categories: { columns: ["translations", "slug", "sort_order"], sort: ["sort_order"], sortField: "sort_order" },
  ...
  services: { columns: ["status", "translations", "sort_order"], sort: ["sort_order"], sortField: "sort_order", archive: true },
  team_members: { columns: ["status", "full_name", "translations", "sort_order"], sort: ["sort_order"], sortField: "sort_order" },
  ...
  company_values: { columns: ["status", "translations", "sort_order"], sort: ["sort_order"], sortField: "sort_order" },
  approaches: { columns: ["status", "translations", "sort"], sort: ["sort"], sortField: "sort", archive: true },
  navigation_links: { columns: ["enabled", "translations", "url", "sort_order"], sort: ["sort_order"], sortField: "sort_order" },
